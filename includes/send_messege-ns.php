<button type="button" class="btn btn-light" data-toggle="modal" data-target="#novi-sad"><i class="material-icons">mail_outline</i></button>

<!-- Modal -->
<div class="modal fade" id="novi-sad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Nova poruka za salon Novi Sad</h5>
